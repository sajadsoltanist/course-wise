...
- **مرحله اول: جستجو ‏(Retrieval)‏:** وقتی سوالی پرسیده می‌شود، سیستم ابتدا در بانک اطلاعات خود جستجو می‌کند و مرتبط‌ترین اطلاعات را پیدا می‌کند.

- **مرحله دوم: ترکیب ‏(Augmentation)‏:** اطلاعات پیدا شده با سوال اصلی ترکیب شده و یک "زمینه غنی" برای مدل زبانی تشکیل می‌شود.

- **مرحله سوم: تولید ‏(Generation)‏:** مدل زبانی بر اساس این زمینه غنی، پاسخی دقیق و مبتنی بر اطلاعات واقعی تولید می‌کند.
...
- **مرحله اول: تغییر کد:** توسعه‌دهنده تغییری در کد ایجاد کرده و آن را به ‏GitHub‏ ارسال می‌کند

- **مرحله دوم: شروع خودکار ‏Pipeline‏:** ‏GitHub Actions‏ متوجه تغییر شده و فرآیند استقرار را شروع می‌کند

- **مرحله سوم: ساخت ایمیج:** کد جدید داخل یک کانتینر ‏Docker‏ بسته‌بندی می‌شود

- **مرحله چهارم: تست اولیه:** بررسی می‌شود که آیا کانتینر به درستی ساخته شده و اجرا می‌شود

- **مرحله پنجم: آپلود به رجیستری:** ایمیج ساخته شده به ‏GitHub Container Registry‏ ارسال می‌شود

- **مرحله ششم: استقرار روی سرور:** سرور تولید ایمیج جدید را دانلود کرده و جایگزین نسخه قبلی می‌کند

- **مرحله هفتم: به‌روزرسانی دیتابیس:** اگر تغییری در ساختار دیتابیس وجود داشته باشد، اعمال می‌شود

- **مرحله هشتم: بررسی سلامت:** سیستم چک می‌کند که آیا همه چیز درست کار می‌کند
